    ...
    for start in range(0, len(source_ids), chunk_size):
        ...
        tables.append(
            Table([sids, simbad_names, sptypes,spquals],
                  names=('source_id', 'simbad_name', 'simbad_sp_type','simbad_sp_qual'))
        )
...
simbad_matches=query_simbad_name_and_sptype(input_table['GaiaEDR3'])

#simbad_matches=query_simbad_all_gaia_ids(input_table['GaiaEDR3'])
merged=join(input_table,simbad_matches, keys_left='GaiaEDR3',keys_right='source_id', join_type='left')
